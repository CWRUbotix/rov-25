...
PROGMEM static const RH_RF22::ModemConfig MODEM_CONFIG_TABLE[] = {
  {0x2b, 0x03, 0xf4, 0x20, 0x41, 0x89, 0x00, 0x36, 0x40, 0x0a, 0x1d, 0x80, 0x60, 0x10, 0x62, 0x2c,
   0x00, 0x08}, // Unmodulated carrier
  {0x2b, 0x03, 0xf4, 0x20, 0x41, 0x89, 0x00, 0x36, 0x40, 0x0a, 0x1d, 0x80, 0x60, 0x10, 0x62, 0x2c,
   0x33, 0x08}, // FSK, PN9 random modulation, 2, 5
  ...
  {0x2b, 0x03, 0xf4, 0x20, 0x41, 0x89, 0x00, 0x36, 0x40, 0x0a, 0x1d, 0x80, 0x60, 0x10, 0x62, 0x2c,
   0x22, 0x08}, // 2, 5
  {0x1b, 0x03, 0x41, 0x60, 0x27, 0x52, 0x00, 0x07, 0x40, 0x0a, 0x1e, 0x80, 0x60, 0x13, 0xa9, 0x2c,
   0x22, 0x3a}, // 2.4, 36
  {0x1d, 0x03, 0xa1, 0x20, 0x4e, 0xa5, 0x00, 0x13, 0x40, 0x0a, 0x1e, 0x80, 0x60, 0x27, 0x52, 0x2c,
   0x22, 0x48}, // 4.8, 45
  {0x1e, 0x03, 0xd0, 0x00, 0x9d, 0x49, 0x00, 0x45, 0x40, 0x0a, 0x20, 0x80, 0x60, 0x4e, 0xa5, 0x2c,
   0x22, 0x48}, // 9.6, 45
  {0x2b, 0x03, 0x34, 0x02, 0x75, 0x25, 0x07, 0xff, 0x40, 0x0a, 0x1b, 0x80, 0x60, 0x9d, 0x49, 0x2c,
   0x22, 0x0f}, // 19.2, 9.6
  {0x02, 0x03, 0x68, 0x01, 0x3a, 0x93, 0x04, 0xd5, 0x40, 0x0a, 0x1e, 0x80, 0x60, 0x09, 0xd5, 0x0c,
   0x22, 0x1f}, // 38.4, 19.6
  {0x06, 0x03, 0x45, 0x01, 0xd7, 0xdc, 0x07, 0x6e, 0x40, 0x0a, 0x2d, 0x80, 0x60, 0x0e, 0xbf, 0x0c,
   0x22, 0x2e}, // 57.6. 28.8
  {0x8a, 0x03, 0x60, 0x01, 0x55, 0x55, 0x02, 0xad, 0x40, 0x0a, 0x50, 0x80, 0x60, 0x20, 0x00, 0x0c,
   0x22, 0xc8}, // 125, 125

  {0x2b, 0x03, 0xa1, 0xe0, 0x10, 0xc7, 0x00, 0x09, 0x40, 0x0a, 0x1d, 0x80, 0x60, 0x04, 0x32, 0x2c,
   0x22, 0x04}, // 512 baud, FSK, 2.5 Khz fd for POCSAG compatibility
  {0x27, 0x03, 0xa1, 0xe0, 0x10, 0xc7, 0x00, 0x06, 0x40, 0x0a, 0x1d, 0x80, 0x60, 0x04, 0x32, 0x2c,
   0x22, 0x07}, // 512 baud, FSK, 4.5 Khz fd for POCSAG compatibility
  ...
  {0x51, 0x03, 0x68, 0x00, 0x3a, 0x93, 0x01, 0x3d, 0x2c, 0x11, 0x28, 0x80, 0x60, 0x09, 0xd5, 0x2c,
   0x21, 0x08}, // 1.2, 75
  {0xc8, 0x03, 0x39, 0x20, 0x68, 0xdc, 0x00, 0x6b, 0x2a, 0x08, 0x2a, 0x80, 0x60, 0x13, 0xa9, 0x2c,
   0x21, 0x08}, // 2.4, 335
  {0xc8, 0x03, 0x9c, 0x00, 0xd1, 0xb7, 0x00, 0xd4, 0x29, 0x04, 0x29, 0x80, 0x60, 0x27, 0x52, 0x2c,
   0x21, 0x08}, // 4.8, 335
  {0xb8, 0x03, 0x9c, 0x00, 0xd1, 0xb7, 0x00, 0xd4, 0x28, 0x82, 0x29, 0x80, 0x60, 0x4e, 0xa5, 0x2c,
   0x21, 0x08}, // 9.6, 335
  {0xa8, 0x03, 0x9c, 0x00, 0xd1, 0xb7, 0x00, 0xd4, 0x28, 0x41, 0x29, 0x80, 0x60, 0x9d, 0x49, 0x2c,
   0x21, 0x08}, // 19.2, 335
  {0x98, 0x03, 0x9c, 0x00, 0xd1, 0xb7, 0x00, 0xd4, 0x28, 0x20, 0x29, 0x80, 0x60, 0x09, 0xd5, 0x0c,
   0x21, 0x08}, // 38.4, 335
  {0x98, 0x03, 0x96, 0x00, 0xda, 0x74, 0x00, 0xdc, 0x28, 0x1f, 0x29, 0x80, 0x60, 0x0a, 0x3d, 0x0c,
   0x21, 0x08}, // 40, 335
};
...
void RH_RF22::setIdleMode(uint8_t idleMode) { _idleMode = idleMode; }
...
bool RH_RF22::init() {
  ...
  // an interrupt occurs
  spiWrite(
    RH_RF22_REG_05_INTERRUPT_ENABLE1, RH_RF22_ENTXFFAEM | RH_RF22_ENRXFFAFULL | RH_RF22_ENPKSENT |
...
void RH_RF22::handleInterrupt() {
  ...
  if (_lastInterruptFlags[0] & RH_RF22_IPKVALID) {
    ...
    if (len > RH_RF22_MAX_MESSAGE_LEN || len < _bufLen) {
      _rxBad++;
      _mode = RHModeIdle;
      clearRxBuf();
...
uint8_t RH_RF22::statusRead() { return spiRead(RH_RF22_REG_02_DEVICE_STATUS); }

uint8_t RH_RF22::adcRead(uint8_t adcsel, uint8_t adcref, uint8_t adcgain, uint8_t adcoffs) {
...
bool RH_RF22::setFrequency(float centre, float afcPullInRange) {
  ...
  if (centre < 240.0 || centre > 960.0)  // 930.0 for early silicon
    return false;
  if (centre >= 480.0) {
    if (afcPullInRange < 0.0 || afcPullInRange > 0.318750) return false;
    centre /= 2;
    fbsel |= RH_RF22_HBSEL;
    afclimiter = afcPullInRange * 1000000.0 / 1250.0;
  }
  else {
    if (afcPullInRange < 0.0 || afcPullInRange > 0.159375) return false;
...
uint8_t RH_RF22::rssiRead() { return spiRead(RH_RF22_REG_26_RSSI); }

uint8_t RH_RF22::ezmacStatusRead() { return spiRead(RH_RF22_REG_31_EZMAC_STATUS); }

void RH_RF22::setOpMode(uint8_t mode) { spiWrite(RH_RF22_REG_07_OPERATING_MODE1, mode); }
...
bool RH_RF22::appendTxBuf(const uint8_t* data, uint8_t len) {
  if (((uint16_t)_bufLen + len) > RH_RF22_MAX_MESSAGE_LEN) return false;
  ATOMIC_BLOCK_START;
...
uint8_t RH_RF22::maxMessageLength() { return RH_RF22_MAX_MESSAGE_LEN; }
...
uint32_t RH_RF22::getLastPreambleTime() { return _lastPreambleTime; }
