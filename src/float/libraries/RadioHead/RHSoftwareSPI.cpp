...
void RHSoftwareSPI::begin() {
  ...
  switch (_frequency) {
    case Frequency1MHz: _delayCounts = 8; break;

    case Frequency2MHz: _delayCounts = 4; break;

    case Frequency4MHz: _delayCounts = 2; break;

    case Frequency8MHz: _delayCounts = 1; break;

    case Frequency16MHz: _delayCounts = 0; break;
  }
}
