...
bool RHDatagram::available() { return _driver.available(); }

void RHDatagram::waitAvailable(uint16_t polldelay) { _driver.waitAvailable(polldelay); }
...
void RHDatagram::setHeaderTo(uint8_t to) { _driver.setHeaderTo(to); }

void RHDatagram::setHeaderFrom(uint8_t from) { _driver.setHeaderFrom(from); }
...
uint8_t RHDatagram::headerFrom() { return _driver.headerFrom(); }

uint8_t RHDatagram::headerId() { return _driver.headerId(); }

uint8_t RHDatagram::headerFlags() { return _driver.headerFlags(); }
