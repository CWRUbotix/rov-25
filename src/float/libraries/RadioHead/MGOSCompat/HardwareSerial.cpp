...
HardwareSerial::HardwareSerial(int uartIndex) { this->uartIndex = uartIndex; }
...
void HardwareSerial::end() { mgos_uart_set_rx_enabled(this->uartIndex, false); }
...
int HardwareSerial::read(void) { return rxByte; }
