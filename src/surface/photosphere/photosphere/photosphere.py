...
PROJECTION_PATH = "src/surface/photosphere/images"  # relative the rov-25 repo
...
class Photosphere(Node):
    def __init__(self) -> None:
        ...
        cam_1_subscriber = self.create_subscription(
            Image, 'image_1', (lambda msg: self.handle_frame_msg(msg, 0)), qos_profile_default
        )

        cam_2_subscriber = self.create_subscription(
